...
/*
    settextfieldElement.js, WAJAF, the WebAbility(r) Javascript Application Framework
    Contains element to control an autofill text field
...
function settextfieldElement(domNodefather, domID, params, feedback, _4glNode)
{
  var self = this;
...
WA.Elements.settextfieldElement = settextfieldElement;

...
func Start() {
	...
	PageCache.Validator = fileValidator
	InstanceCache.Validator = fileValidator
	CodeCache.Validator = fileValidator
	TemplateCache.Validator = fileValidator
	LanguageCache.Validator = fileValidator
	LibraryCache.Validator = fileValidator
}
